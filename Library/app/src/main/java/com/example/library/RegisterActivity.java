...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance("https://libraryreservationsystem-f2a88-default-rtdb.europe-west1.firebasedatabase.app/")
                .getReference("users");
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (firebaseUser != null) {
                            ...
                            User user = new User(name, surname, email, phone, gender, role);
